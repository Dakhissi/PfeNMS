...
public class SwaggerConfiguration {
	...
	@Bean
	GroupedOpenApi deviceManagementApi() {
		return GroupedOpenApi.builder()
				.pathsToMatch("/api/devices/**", "/api/device-interfaces/**", "/api/system-units/**", "/api/ip-profiles/**", "/api/icmp-profiles/**", "/api/udp-profiles/**", "/api/snmp-polling/**")
